...
public interface TicketAiService {
    ...
    /**
     * AI开发助手聊天 - 带上下文记忆
     * 用户可以针对当前工单持续提问，AI会记住之前的对话
     */
    @SystemMessage("""
            你是一位资深的JavaWeb开发顾问和技术导师。
            用户正在开发一个项目，你已经了解了项目的基本信息。
            请根据用户的提问，提供专业的开发建议、技术指导和问题解答。
            ...
            如果用户问的是与当前项目无关的问题，你也可以回答，但优先围绕项目开发相关的话题。
            """)
    String chatWithDeveloper(@MemoryId Long ticketId, @UserMessage String userMessage);
}
